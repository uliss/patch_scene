...
static const ConnectorModelMap& model_map()
{
    static ConnectorModelMap map {
        ...
        { ConnectorModel::XLR_MINI,                { "xlr_mini",         "xlr_mini",         "mini XLR" } },
        ...
        { ConnectorModel::TOSLINK_MINI,            { "toslink_mini",     "toslink_mini",     "mini Toslink" } },
        ...
        { ConnectorModel::USB_MINI_A,              { "usb_mini_a",       "usb_mini_a",       "mini USB 2.0 type A" } },
        { ConnectorModel::USB_MINI_B,              { "usb_mini_b",       "usb_mini_b",       "mini USB 2.0 type B" } },
        { ConnectorModel::USB_MICRO_A,             { "usb_micro_a",      "usb_micro_a",      "micro USB 2.0 type A" } },
        { ConnectorModel::USB_MICRO_B,             { "usb_micro_b",      "usb_micro_b",      "micro USB 2.0 type B" } },
        ...
        { ConnectorModel::USB_3_0_MICRO_B,         { "usb3_micro_b",     "usb3_micro_b",     "micro USB super speed" } },
        ...
        { ConnectorModel::DIN_MINI_3,              { "din_mini_3",       "din_mini_3",       "mini DIN 3" } },
        { ConnectorModel::DIN_MINI_4,              { "din_mini_4",       "din_mini_4",       "mini DIN 4" } },
        { ConnectorModel::DIN_MINI_5,              { "din_mini_5",       "din_mini_5",       "mini DIN 5" } },
        { ConnectorModel::DIN_MINI_6,              { "din_mini_6",       "din_mini_6",       "mini DIN 6" } },
        { ConnectorModel::DIN_MINI_7,              { "din_mini_7",       "din_mini_7",       "mini DIN 7" } },
        { ConnectorModel::DIN_MINI_8,              { "din_mini_8",       "din_mini_8",       "mini DIN 8" } },
        // video
        { ConnectorModel::SCART,                   { "scart",            "scart",            "SCART" } },
        { ConnectorModel::HDMI,                    { "hdmi",             "hdmi",             "HDMI" } },
        { ConnectorModel::HDMI_MINI,               { "hdmi_mini",        "hdmi_mini",        "mini HDMI" } },
        { ConnectorModel::HDMI_MICRO,              { "hdmi_micro",       "hdmi_micro",       "micro HDMI" } },
        ...
        { ConnectorModel::DISPLAY_PORT_MINI,       { "display_port_mini","display_port_mini","mini Display Port" } },
